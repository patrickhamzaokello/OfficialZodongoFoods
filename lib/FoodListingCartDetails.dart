...
class FoodListingCartDetails extends StatefulWidget {
  final heroTag;
  final foodName;
  final foodPrice;
  ...
  @override
  _FoodListingCartDetailsState createState() => _FoodListingCartDetailsState(
      this.heroTag,
      this.foodName,
      this.foodPrice,
      this.foodDescription,
...
class _FoodListingCartDetailsState extends State<FoodListingCartDetails> {
  _FoodListingCartDetailsState(this.heroTag, this.foodName, this.foodPrice,
